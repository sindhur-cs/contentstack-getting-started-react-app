...
const CampaignCard = ({ description, image, title, id, healthBenefits }: { description: string, image: any, title: string, id: string, healthBenefits: any }) => {
    ...
    return (
        <div className="card" onClick={() => navigate(`/campaign/${id}`)}>
